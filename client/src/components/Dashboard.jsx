...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const currentActive = wishlist.items.find(
  ...
  return (
    <>
      <div
        className={`dashboard-shell ${moodboardOnly ? "dashboard-shell--moodboard" : ""}`}
      >
        ...
        {pageError ? (
          <div className="form-error page-error">{pageError}</div>
        ) : null}
